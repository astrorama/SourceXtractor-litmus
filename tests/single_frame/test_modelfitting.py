...
def test_magnitude(modelfitting_catalog, reference, stuff_simulation, tolerances):
    ...
    """
    target_closest = stuff_simulation.get_closest(
        modelfitting_catalog['world_centroid_alpha'], modelfitting_catalog['world_centroid_delta']
    )
    ...
    mag_diff = np.abs((target_closest.magnitude - target_mag))
    ref_diff = np.abs((ref_closest.magnitude - ref_mag))
