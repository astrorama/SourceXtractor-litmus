...
def test_iso_flux(mef_catalog, sim11_r_reference, mef_frame_cross, sim11_r_cross):
    """
    ...
    """
    catalog_intersect, ref_intersect = intersect(mef_frame_cross, sim11_r_cross)
...
def test_auto_flux(frame, mef_catalog, sim11_r_reference, mef_frame_cross, sim11_r_cross):
    """
...
def test_aper_flux(frame, aper_idx, mef_catalog, sim11_r_reference, mef_frame_cross, sim11_r_cross):
    """
