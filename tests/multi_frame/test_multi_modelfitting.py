...
def test_magnitude(modelfitting_catalog, stuff_simulation_r, stuff_simulation_g, tolerances):
    ...
    """
    target_closest_r = stuff_simulation_r.get_closest(
        modelfitting_catalog['world_centroid_alpha'], modelfitting_catalog['world_centroid_delta']
    )
    target_closest_g = stuff_simulation_g.get_closest(
        modelfitting_catalog['world_centroid_alpha'], modelfitting_catalog['world_centroid_delta']
    )
    ...
    assert np.isclose(
        target_mag_r, target_closest_r.magnitude,
        rtol=tolerances['multiframe_magnitude']
    ).all()
    assert np.isclose(
        target_mag_g, target_closest_g.magnitude,
        rtol=tolerances['multiframe_magnitude']
    ).all()
