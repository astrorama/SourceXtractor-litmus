...
def test_iso_flux(multi_compressed_catalog, sim11_r_reference, multi_compressed_cross, sim11_r_cross):
    """
    ...
    """
    catalog_intersect, ref_intersect = intersect(multi_compressed_cross, sim11_r_cross)
...
def test_auto_flux(frame, multi_compressed_catalog, sim11_r_reference, multi_compressed_cross, sim11_r_cross):
    """
    ...
    real_flux = sim11_r_cross.all_fluxes[ref_intersect[inframe_filter]]
...
def test_aper_flux(frame, aper_idx, multi_compressed_catalog, sim11_r_reference, multi_compressed_cross, sim11_r_cross):
    """
...
def test_generate_report(multi_compressed_catalog, sim11_r_reference, sim11_r_simulation, datafiles, module_output_area):
    ...
    with plot.Report(module_output_area / 'report.pdf') as report:
        ...
        dist.add('SExtractor2 (R)', sim11_r_reference, 'X_IMAGE', 'Y_IMAGE', marker='o')
